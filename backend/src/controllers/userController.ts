...
const getAllUsers = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (searchString) {
      filters.OR = [
        { encryptedFirstName: { contains: encryptData(searchString), mode: 'insensitive' } },
        { encryptedLastName: { contains: encryptData(searchString), mode: 'insensitive' } },
        { encryptedEmail: { contains: encryptData(searchString), mode: 'insensitive' } },
        { encryptedPhone: { contains: encryptData(searchString), mode: 'insensitive' } },
      ]
    }
