...
class DummyCategoryApiService {
  ...
  Future<DataResponse<List<CategoryModel>>> getAllCategories({
    ...
    final jsonContent = await rootBundle.loadString(
        'assets/data/dummy_data/category/get_all_categories_response.json');
  ...
  Future<DataResponse<List<CategoryModel>>> getSubCategories({
    required String apiKey,
    required String language,
    int? id,
    int? categoryNumber,
    ...
    final jsonContent = await rootBundle.loadString(
        'assets/data/dummy_data/category/get_sub_categories_response.json');
