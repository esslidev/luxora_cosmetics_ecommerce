...
class _CartApiService implements CartApiService {
  ...
  Future<HttpResponse<DataResponse<CartModel>>> syncCart({
    ...
    required Map<String, List<CartItemModel>> items,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<DataResponse<CartModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final value = DataResponse<CartModel>.fromJson(
      _result.data!,
  ...
  Future<HttpResponse<DataResponse<CartItemModel>>> addItemToCart({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<DataResponse<CartItemModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = DataResponse<CartItemModel>.fromJson(
      _result.data!,
  ...
  Future<HttpResponse<DataResponse<List<CartItemModel>>>> addManyItemsToCart({
    required String accessToken,
    required String language,
    required Map<String, List<int>> productIds,
    String contentType = 'application/json',
  }) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(productIds);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<DataResponse<List<CartItemModel>>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: contentType,
    ...
    final value = DataResponse<List<CartItemModel>>.fromJson(
      _result.data!,
  ...
  @override
  Future<HttpResponse<DataResponse<dynamic>>> clearCart({
    required String accessToken,
    required String language,
    String contentType = 'application/json',
  }) async {
